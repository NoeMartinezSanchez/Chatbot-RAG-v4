...
- **Modelo generativo**: Groq con Llama 3.3 70B (migrado desde Gemini)
...
6. [Modelo Generativo: Groq con Llama 3.3 70B](#-modelo-generativo-groq-con-llama-33-70b)
...
GROQ_API_KEY	API key para Groq con Llama 3.3 70B	✅ Sí
...
🧠 Modelo Generativo: Groq con Llama 3.3 70B
...
Aspecto	Gemini	Groq	Impacto
Costo por 1M tokens	$2.50 USD	$0.79 USD	68% más barato
Capa gratuita real	❌ Requiere tarjeta	✅ Sin tarjeta	Sin barrera
Velocidad	~200 tok/seg	~394 tok/seg	Más rápido
Modelo	Propietario	Open-source	Transparente
Latencia TTFT	~150ms	~50-150ms	Similar
Tasa de Éxito
...
llama-3.3-70b-versatile	~394 tok/seg	Default, alta calidad
...
│   └── wrappers.py                 # Wrapper con memoria + conciencia temporal
├── models/
│   ├── groq_wrapper.py             # Principal (Llama 3.3 70B)
...
Modelo	✅ Operativo	Groq Llama 3.3 70B
